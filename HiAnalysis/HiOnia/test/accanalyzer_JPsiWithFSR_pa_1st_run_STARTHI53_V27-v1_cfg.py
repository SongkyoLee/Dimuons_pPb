...
options.outputFile = "JPsiWithFSR_pa_1st_run_STARTHI53_V27-v1_GENOLNY_test.root"
options.secondaryOutputFile = "PRMC_eff_DataSet.root"
options.inputFiles = 'file:/afs/cern.ch/work/k/kyolee/private/CMSSW_5_3_27/src/HIN-pAWinter13-JPsiWithFSR_5TeV02_1st_nofilter_byhand_out50k.root'
...
process.hionia = cms.EDAnalyzer('MyAccAnalyzer',
...
#                                minimumFlag = cms.bool(False),  # KYO
                                doGenMatching = cms.untracked.bool(False), # KYO
                                minimumFlag = cms.bool(True),  # KYO
